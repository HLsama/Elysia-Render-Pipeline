...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed partial class UniversalRenderer : ScriptableRenderer
    {
        ...
        public UniversalRenderer(UniversalRendererData data) : base(data)
        {
            ...
            m_DefaultStencilState = StencilState.defaultValue;//这里改总的模板设置
            m_DefaultStencilState.enabled = stencilData.overrideStencilState;//控制是否开启模板缓冲区(原值：stencilData.overrideStencilState)
            m_DefaultStencilState.SetCompareFunction(stencilData.stencilCompareFunction);//同时要将下面的设置一起修改才能生效
