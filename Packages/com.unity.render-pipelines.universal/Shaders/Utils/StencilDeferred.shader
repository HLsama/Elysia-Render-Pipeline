Shader "Hidden/Universal Render Pipeline/StencilDeferred"
{
    Properties
    {
        ...
        _EyEyeBlendDirStencilRef ("EyEyeBlendDirStencilRef", Int) = 0
        _EyEyeBlendDirStencilReadMask ("EyEyeBlendDirStencilReadMask", Int) = 0
        _EyEyeBlendDirStencilWriteMask ("EyEyeBlendDirStencilWriteMask", Int) = 0
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Stencil {
                //自定义光照的Stencil
                Ref [_EyEyeBlendDirStencilRef]
                ReadMask [_EyEyeBlendDirStencilReadMask]
                WriteMask [_EyEyeBlendDirStencilWriteMask]
                Comp Equal
                Pass Keep
                Fail Keep
                ZFail Keep
